...
<body>
	...
	<c:forEach items="${sessionScope.carrito }" var="ele" varStatus="indice">
		...
		<tr>
			...
			<td>${producto}</td>
			<td><a href="GestionCarrito?opcion=eliminar2&posicion=${indice.index }">Eliminar</a></td>
	...
	<a href="GestionCarrito?opcion=comprar2">Comprar</a></br>
